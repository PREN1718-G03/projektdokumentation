...
Um die Kosten der Elektronischen Komponenten zu erfassen, werden in der Tabelle \ref{tab:elektronikkosten} alle Bauteile aufgelistet, welche für die Umsetzung in Frage kommen.
\begin{table}[h!]
	\begin{tabular}{|p{0.3\textwidth}|p{0.3\textwidth}|p{0.3\textwidth}|}
		\hline
...
%TODO Grad zeichen?? textdegree hat nicht funktioniert...
Das Positionieren und Umschliessen von IR-Sender und Empfänger ist sehr wichtig. Sowohl der Sender als auch der Empfänger müssen in einem bestimmten Winkel platziert werden, damit die Erkennung eines Objekts richtig ist - und zwar im Winkel von 45 Grad wie in folgender Abbildung:
