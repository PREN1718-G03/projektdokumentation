...
Bevor wir mit unserer, eigenständigen Recherche begannen, sassen wir im Team zusammen und machten ein Brainstorming. Dabei erhielten wir die folgenden Ideen:
...
\begin{displaymath}
	m=V*\rho
\end{displaymath}
$V_{Klotz}=(5cm)^3=125\cdot10^{-6} m^3$ \\
...
\begin{tabular}{|p{0.3\textwidth}|p{0.7\textwidth}|}
  ...
  Sensorwahl & http://www-mech.eng.cam.ac.uk/profiles/fleck/papers/134.pdf \\
	...
	\hline
  I2C bitbanging & https://calcium3000.wordpress.com/2016/08/19/i2c-bit-banging-tutorial-part-i/ \\
  \hline
\end{tabular}
...
\begin{tabular}{|p{0.25\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|p{0.25\textwidth}|}
  ...
  \hline
  LSM6DS3US & I2C oder SPI & 3 CHF & https://goo.gl/erby3f \\
  \hline
\end{tabular}
...
\begin{tabular}{|p{0.2\textwidth}|p{0.15\textwidth}|p{0.15\textwidth}|p{0.4\textwidth}|}
  ...
  \textbf{Name} & \textbf{Interface} & \textbf{Preis} & \textbf{Datenblatt} \\
  \hline
  VCNL4200 & I2C & 3 CHF & https://www.vishay.com/optical-sensors/list/product-84430/ \\
  \hline
\end{tabular}
...
\begin{landscape}
\subsection{Gewichtete Bewertung}
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}
	\hhline{|t:==========:t|}
	\multicolumn{2}{||c|}{\textbf{Varianten}}&\multicolumn{2}{|c|}{\textbf{Variante 1}}  &	\multicolumn{2}{|c|}{\textbf{Variante 2}}  & 	\multicolumn{2}{|c|}{\textbf{Variante 3}} & 	\multicolumn{2}{|c||}{\textbf{Variante 4}} \\
	\hhline{||----------||}
	\multicolumn{1}{||c|}{Bewertungskriterien}& Gewichtung & Punkte & Ergebnis &Punkte & Ergebnis & Punkte & Ergebnis & Punkte & \multicolumn{1}{|c||}{Ergebnis} \\
	\hhline{|b:=|=|=|=|=|=|=|=|=|=:b|}
	Gewicht& 3 & 2 & 6 & 1 & 3 & 5 & 15 & 5 & 15 \\
	\hline
	Realisierbarkeit& 5 & 3 & 15 & 4 & 20 & 1 & 5 & 1 & 5 \\
	\hline
	Kosten& 3 & 3 & 9 & 3 & 9 & 2 & 6 & 1 & 3 \\
	\hline
	Herstellungsaufwand& 3 & 3 & 9 & 3 & 9 & 1 & 3 & 1 & 3 \\
	\hline
	Energieverbrauch& 4 & 2 & 8 & 2 & 8 & 2 & 8 & 3 & 12 \\
	\hline
	Geschwindigkeit (Antrieb)& 4 & 3 & 12 & 3 & 12 & 2 & 8 & 3 & 12 \\
	\hline
	Balance (Schwanken)& 2 & 3 & 6 & 2 & 4 & 3 & 6 & 4 & 8 \\
	\hline
	Absetzgenauigkeit& 3 & 2 & 6 & 3 & 9 & 3 & 9 & 3 & 9 \\
	\hline
	Last Greifen& 4 & 4 & 16& 4 & 16 & 4 & 16 & 3 & 12 \\
	\hline
	Ausfallsicherheit& 5 & 3 & 15 & 4 & 20 & 2 & 10 & 1 & 5 \\
	\hline
	Ästhetik& 1 & 1 & 1 & 2 & 2 & 3 & 3 & 3 & 3 \\
	\hline
	&  &  &  &  &  &  &  &  &  \\
	\hline
	&  &  &  &  &  &  &  &  &  \\
	...
	&  &  &  &  &  &  &  &  &  \\
	\hhline{|-|-|=|=|=|=|=|=|=|=|}
	\multicolumn{2}{c|}{}& \textbf{Rang} & \textbf{Total} & \textbf{Rang} & \textbf{Total} & \textbf{Rang} & \textbf{Total} & \textbf{Rang} & \textbf{Total} \\
	\cline{3-10}
	\multicolumn{2}{c|}{}& \textbf{2} & 103 & \cellcolor{lightgray} \textbf{1} & 112 & \textbf{3} & 89 & \textbf{4} & 87 \\
	\cline{3-10}
	\end{tabular}
\end{landscape}
...
\textbf{Variante 1: Gondel zweifach}\\
Der Hauptgrund, wieso diese Variante der Variante 2 das Nachsehen hatte, liegt hauptsächlich an der Realisierbarkeit. Durch die zwei auseinanderliegenden Rollen würde wegen den verschiedenen Steigungen am Seil das Gerät sich nicht mehr in horizontaler Lage befinden. Dies auszugleichen würde den Aufwand und auch die Kosten stark erhöhen. Zudem könnte die Absetzgenauigkeit beeinträchtigt werden, da die Kamera ebenfalls nicht horizontal liegen würde. Auch die Last heben und senken mit einem Seil kann durch die Beschleunigung in Schwingung geraten und das Absetzen Massiv erschweren. Ein grosser Vorteil liegt aber in der Stabilität des Gerätes gegen Schwanken in x-Richtung da das Gerät zweifach aufgehängt wäre.  \\
\\
\textbf{Variante 2: Geklemmt}\\
Durch die Gelenkige Aufhängung des Gerätes ist die Horizontale Lage durch den Schwerpunkt gegeben. Ein Problem könnte aber im Vergleich zur Variante 1 die Schwankung sein. Diese ist aber mit Dämpfer zu vermindern oder gar ganz zu vermieden. Weil die Horizontale Lage nicht erzwungen werden muss, ist es auch einfacher zu Realisieren. Durch die Zahnstange kann die Absetzgenauigkeit verbessert werden, da diese weniger stark in Schwingung gerät als das Seil. Das Gewicht ist aber durch die Zahnstange hoch. Zudem überragt die hochgezogene Stange das Seil, was Schwankungen begünstigen kann.  \\
\\
\textbf{Variante 3: Zeppelin}
Der grösste Vorteil ist, dass durch den Heliumbalon die Gewichtskraft massiv verringert werden kann. Es kann auch bei der Antriebsleistung für die Fortbewegung und somit auch bei der Akkuleistung eingespart werden. Der Hebemechanismus ist mit einem gelochten T-profil gelöst, welches gleichzeitig stark gegen Biegung und leicht ist. Die Probleme sind aber die Realisierbarkeit und die Ausfallsicherheit. Der Heliumballon müsste sehr gross werden um einen Nennenswerten Einfluss auf die Gewichtskraft zu bewirken. Zudem kann Wind auftreten währen dem Fahren, was den Heliumballon stark beeinflusst. Die würde sehr wahrscheinlich zu einem Aussfall des gesamten Gerätes führen.
