...
Durch die Konzeptentwicklung konnte sichergestellt werden, dass die Anforderungen durch unser Konzept erfüllt werden.
...
Das Gerät muss innerhalb von zwei Minuten startbereit sein. Die Zeit um den Zielraum zu erreichen liegt bei maximal vier Minuten. In der Abbildung \ref{fig:Ablaufdiagramm} sehen Sie eine anschauliche Darstellung des Ablaufs.
...
Im Blockdiagramm (Abb. \ref{fig:Blockdiagramm})s sind die Schnittstellen graphisch dargestellt.
...
\includepdf[pages=1]{Meilensteinbericht_03.pdf}
\end{document}