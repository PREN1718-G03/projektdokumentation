...
\begin{abstract}
	...
	Das Ergebnis dieser Arbeit ist ein Konzept einer Laufkatze, welche mit Seilrollen angetrieben wird. Unterhalb der Aufhängung ist die Montageplatte und die Hubeinrichtung angebracht. Diese besteht aus einem Haken welcher mit einer geführten Seilwindenkonstruktion gehoben und gesenkt werden kann. Die Zielplatte wird mittels Bilderkennung erkannt und die Distanz mit Ultraschallsensoren und dem Zählen der Schritte von den Motoren.
...
%TODO Pascal, Beschreibung Position berechnen? Entweder hier raus löschen od. noch beschreiben?
